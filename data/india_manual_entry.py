...
old workflow of editing a constant at the top of a script and running it.
    ...
    python -m data.india_manual_entry set 2026-05 --mfg-pmi 57.2 --svc-pmi 60.1 --gst 2.01
    python -m data.india_manual_entry set 2026-05 --cpi 2.8 --core-cpi 4.1
    python -m data.india_manual_entry show 2026-05
...
def cmd_status(args):
    ...
    if gaps:
        newest = rows[0]["month"]
        print(f"  e.g.  python -m data.india_manual_entry set {newest} --mfg-pmi 57.2")
