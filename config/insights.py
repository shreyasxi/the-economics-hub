...
**How to read this chart:** Central government spending in each month of the financial year, in ₹ lakh crore: capital expenditure in blue and revenue expenditure in red, derived from the year-to-date figures in the Controller General of Accounts' monthly accounts. The dotted blue line is the full-year capital expenditure Budget Estimate divided by twelve, the monthly average that would spend the whole budget, and the badge shows capital expenditure so far as a share of that Budget Estimate. The black line (right axis) is capital expenditure as a share of that month's total spending, and the dashed green line marks a 25% reference level, not an official target. March usually shows a jump in revenue spending as departments close the year's accounts.
