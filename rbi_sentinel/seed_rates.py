...
history and corrections — run it only if a decision was recorded wrongly:
    ...
    python -m rbi_sentinel.seed_rates        (from the project root)
...
from rbi_sentinel.config import DB_PATH   # honours RBI_SENTINEL_DB for tests on a copy
...
if __name__ == "__main__":
    ...
    # A rate change alters charts 02 and 05. Regenerate and publish the charts
